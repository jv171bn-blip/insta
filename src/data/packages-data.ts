...
export const followerPackagesData: Omit<Package, 'originalPrice' | 'isDiscount'>[] = [
    { followers: 5000, price: 19.90, isBestValue: true, features: ["Seguidores 100% Brasileiros", "Não afeta o desempenho", "Garantia anti-queda"], checkoutLink: "https://checkout.instabostt.store/VCCL1O8SCCNI" },
    ...
    { followers: 22500, price: 59.90, features: ["Seguidores 100% Brasileiros", "Não afeta o desempenho", "Garantia anti-queda"], checkoutLink: "https://checkout.instabostt.store/VCCL1O8SCCNL" },
